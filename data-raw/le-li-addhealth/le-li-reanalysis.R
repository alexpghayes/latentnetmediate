...
fa <- vsp(graph, rank = 120, degree_normalize = FALSE)
fa

nodelm(level ~ . - id + US(A, 100), graph)
...
equatiomatic::extract_eq(outcome)
...
plot(emmeans::emmeans(covariate_only, ~ sex + grade + race))
